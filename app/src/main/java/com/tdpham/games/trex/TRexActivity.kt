...
class TRexActivity : BaseGameActivity() {
    ...
    override val gameTitle get() = getString(R.string.how_to_play_guide, getString(R.string.game_trex))
    override val gameInstructions get() = getString(R.string.game_trex_instructions)
