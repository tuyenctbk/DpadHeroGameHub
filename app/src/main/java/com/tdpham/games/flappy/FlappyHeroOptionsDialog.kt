...
object FlappyHeroOptionsDialog {
    ...
    fun show(context: Context, onDismiss: () -> Unit) {
        ...
        dialog.setContentView(R.layout.dialog_flappy_hero_settings)
        ...
        fun updateLevelText() {
            ...
            val (valRes, descRes) = when(index) {
                0 -> R.string.flappy_hero_level_1 to R.string.flappy_hero_level_1_desc
                2 -> R.string.flappy_hero_level_3 to R.string.flappy_hero_level_3_desc
                else -> R.string.flappy_hero_level_2 to R.string.flappy_hero_level_2_desc
            }
